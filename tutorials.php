    ...
    <div class="container-fluid py-4">
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="sidebar">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <nav class="nav flex-column" id="lessonNav">
                                <a class="nav-link active" href="#lesson1">1. Introduction to HTML</a>
                                <a class="nav-link" href="#lesson2">2. HTML Lists</a>
                                <a class="nav-link" href="#lesson3">3. Attributes</a>
                                <a class="nav-link" href="#lesson4">4. Lists</a>
                                <a class="nav-link" href="#lesson5">5. Images</a>
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-9">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h1 class="text-center mb-4">Welcome to the HTML Tutorial Series!</h1>
                        <div class="alert alert-info">
                            <p class="mb-0">In this series, you will learn the fundamentals of HTML, empowering you to create structured and engaging web pages. Each lesson is carefully designed to build upon previous concepts.</p>
                        </div>
